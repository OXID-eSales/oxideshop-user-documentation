...
#. Ordnen Sie eine Versandkostenregel einer Versandart zu.
   ...
   .. hint:: Der Versandart müssen mindestens eine Versandkostenregel und eine Zahlungsart zugewiesen sein.
...
Im Demo-Shop sind die Kategorien beispielsweise wie folgt den Versandkostenregeln zugeordnet und priorisiert (:ref:`oxbafz01`, Pos. 2):
...
Durch das Aktivieren der Einstellung :guilabel:`Keine weiteren Regeln nach dieser berechnen` (:ref:`oxbafz01`, Pos. 3) ist sichergestellt, dass ein Kunde jeweils nur die höchsten Versandkosten bezahlt.
...
In unserem Beispiel wird die Überführung entsprechend für jede Lieferung separat abgerechnet (:ref:`oxbafz01`, Pos.1), die Kosten für die Spedition oder den Paketversand dagegen werden einmalig pro Warenkorb berechnet.
