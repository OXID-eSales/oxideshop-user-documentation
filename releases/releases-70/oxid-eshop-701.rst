...
Release-Datum: 17.01.2024

Änderungen
----------

OXID eShop 7.0.1 enthält Korrekturen und kleinere Verbesserungen.

Verbesserungen und Anpassungen
------------------------------

Änderungen bei der Kompilierung im Metapaket finden Sie unter `<https://github.com/OXID-eSales/oxideshop_metapackage_ce/compare/v7.0.0...v7.0.1>`_.
...
* APEX Theme (Update von 1.0.0 auf 1.2.1): `Changelog 1.2.1 <https://github.com/OXID-eSales/apex-theme/blob/v1.2.1/CHANGELOG-1.x.md#v121---2024-01-15>`_
...
* WYSIWYG Editor + Mediathek module (Update von 3.0.1 auf 3.0.2): `Changelog 3.0.2 <https://github.com/OXID-eSales/ddoe-wysiwyg-editor-module/blob/v3.0.2/CHANGELOG.md#302---2023-11-22>`_
...
* `OXID eShop CE 7.0.2 <https://github.com/OXID-eSales/oxideshop_ce/blob/v7.0.2/CHANGELOG-7.0.md>`_
