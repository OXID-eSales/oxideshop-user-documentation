...
Aus Sicherheitsgründen erfordert OXID eShop 7.0.2 die Composer-Version 2.7.
...
Die Korrekturen finden Sie im `Changelog <https://github.com/OXID-eSales/oxideshop_ce/blob/v7.0.3/CHANGELOG-7.0.md#v703---2024-02-20>`_.
...
* OXID eShop CE (Update von 7.0.2 auf 7.0.3): `Changelog 7.0.3 <https://github.com/OXID-eSales/oxideshop_ce/blob/v7.0.3/CHANGELOG-7.0.md#v703---2024-02-20>`_
