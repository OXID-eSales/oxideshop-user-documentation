...
* OXID eShop CE 6.6.0
* OXID eShop PE 6.4.1 - unverändert
* OXID eShop EE 6.5.4
* Theme "Flow" 3.6.0
* Theme "Wave" 1.5.0
* Amazon Pay 3.6.4 unverändert
* GDPR Opt-In 2.3.1 unverändert
* Klarna 5.3.0
* Paymorrow 2.0.3 unverändert
* PAYONE 1.3.1 unverändert
* PayPal 6.2.1
...
* Theme "Wave" (Update von 1.4.0 auf 1.5.0), `Changelog 1.4.0 <https://github.com/OXID-eSales/wave-theme/blob/v1.5.0/CHANGELOG.md>`_
...
* Visual CMS, PE/EE (Update von 3.4.0 auf 3.5.1)
