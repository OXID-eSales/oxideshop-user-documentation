...
* Klarna (update from 5.5.1 to 5.5.2) `Changelog 5.5.2 <https://github.com/topconcepts/OXID-Klarna-6/blob/v5.5.2/CHANGELOG.md>`_
...
* PAYONE (update from 1.5.1 to 1.6.0) `Changelog 1.6.0 <https://github.com/PAYONE-GmbH/oxid-6/blob/v1.6.0/Changelog.txt>`_
