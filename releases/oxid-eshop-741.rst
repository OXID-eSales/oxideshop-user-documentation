...
* ``composer/composer`` von 2.8.12 auf 2.9.3
...
**WYSIWYG Editor** (v6.0.1 auf v6.0.2):
...
**Visual CMS** (v9.1.0 auf v9.2.0, nur Professional und Enterprise Edition):
...
* Media Library Module v4.1.0 (oder v3.0.0 bleibend)
...
* OXID eShop Unified Namespace Generator v5.2.0
* OXID eShop Views Generator v2.2.0
* Twig Admin Theme v3.0.1
* Twig Component v2.7.0
* WYSIWYG Editor Module von v6.0.1 auf v6.0.2 (oder v5.0.1 bleibend): `Changelog <https://github.com/OXID-eSales/ddoe-wysiwyg-editor-module/blob/v6.0.2/CHANGELOG.md>`_
...
* Visual CMS Modul von v9.1.0 auf v9.2.0 (oder v8.0.2 bleibend)
