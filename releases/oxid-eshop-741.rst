...
* ``composer/composer`` from 2.8.12 to 2.9.3
...
**WYSIWYG Editor** (v6.0.1 to v6.0.2):
...
**Visual CMS** (v9.1.0 to v9.2.0, Professional and
...
* Media Library Module v4.1.0 (or v3.0.0 remaining)
...
* WYSIWYG Editor Module from v6.0.1 to v6.0.2 (or v5.0.1 remaining): `Changelog <https://github.com/OXID-eSales/ddoe-wysiwyg-editor-module/blob/v6.0.2/CHANGELOG.md>`_
...
* Visual CMS Module from v9.1.0 to v9.2.0 (or v8.0.2 remaining)
