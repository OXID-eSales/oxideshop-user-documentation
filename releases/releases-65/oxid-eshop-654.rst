...
Veröffentlichungstermin: 27.02.2024
...
Änderungen in der Compilation finden Sie im Metapackage unter `<https://github.com/OXID-eSales/oxideshop_metapackage_ce/compare/v6.5.3...v6.5.4>`_.
...
* OXID eShop CE (Update von 6.14.1 zu 6.14.2): `Changelog 6.14.2 <https://github.com/OXID-eSales/oxideshop_ce/blob/v6.14.2/CHANGELOG.md>`_
