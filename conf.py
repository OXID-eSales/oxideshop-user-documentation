...
# -*- coding: utf-8 -*-
#
# OXID eShop 6 documentation build configuration file, created by
# sphinx-quickstart on Wed Mar 22 11:48:53 2017.
#
...
html_context = {
    ...
    'versions': [
          ...
          ('7.5', 'https://docs.oxid-esales.com/eshop/en/7.5/'),
          ],
    'languages':
         [('EN', 'https://docs.oxid-esales.com/eshop/en/7.5/'),
          ('DE', 'https://docs.oxid-esales.com/eshop/de/7.5/')],
...
#
html_title = 'OXID eShop 7.5 | User documentation'
...
htmlhelp_basename = 'OXIDeShop7doc'
...
latex_documents = [
    (master_doc, 'OXIDeShop7.tex', 'OXID eShop 7 Documentation',
...
man_pages = [
    (master_doc, 'oxideshop7', 'OXID eShop 7 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OXIDeShop7', 'OXID eShop 7 Documentation',
     author, 'OXIDeShop7', 'One line description of project.',
     'Miscellaneous'),
]
