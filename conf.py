...
html_context = {
    ...
    'languages':
         [('EN', 'https://docs.oxid-esales.com/eshop/en/7.4/'),
          ('DE', 'https://docs.oxid-esales.com/eshop/de/7.4/')],
...
#
html_title = 'OXID eShop 7.4 | User documentation'
