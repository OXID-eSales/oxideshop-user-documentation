...
html_context = {
    ...
    'languages':
         [('EN', 'https://docs.oxid-esales.com/eshop/en/6.3/'),
          ('DE', 'https://docs.oxid-esales.com/eshop/de/6.3/')],
...
#
html_title = 'OXID eShop 6.3 | User documentation'
...
latex_documents = [
    (master_doc, 'OXIDeShop63.tex', 'OXID eShop 6.3 Documentation',
...
man_pages = [
    (master_doc, 'oxideshop63', 'OXID eShop 6.3 Documentation',
     [author], 1)
]
