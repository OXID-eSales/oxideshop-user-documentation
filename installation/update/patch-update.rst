...
For example, use the following steps to update the compilation from an existing version 6.5.x to version 6.5.5.
...
#. In the :file:`composer.json` file located in the main store directory, update the metapackage version.
   ...
   b. Run the command, in our example for updating a community edition 6.5.1 to 6.5.5:
