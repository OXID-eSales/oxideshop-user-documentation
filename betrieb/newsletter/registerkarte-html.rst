...
.. image:: ../../media/screenshots-de/oxaaie01.png
...
:guilabel:`Vorlage` |br|
In der Enterprise und der Professional Edition kann der Inhalt des Newsletters komfortabel in einen Editor eingegeben werden. Dieser arbeitet nach dem Prinzip WYSIWYG (What You See Is What You Get), er zeigt also den Text so an, wie er später im Newsletter zu sehen sein wird. Der Editor bietet die Möglichkeit der Textformatierung, des Einfügens von Bildern und von Links.

In der Community Edition kann standardmäßig nur Text in ein großes Eingabefeld eingetragen werden. Für die gewünschte Formatierung sorgen HTML-Tags. Mit \<h1\>...\</h1\> wird beispielsweise Text als erste Überschrift formatiert. Einen guten Überblick zur Auszeichnungen von Text mit HTML-Tags erhalten Sie bei `SelfHTML <http://de.selfhtml.org>`_.
...
.. Intern: oxaaie, Status:, F1: newsletter_main