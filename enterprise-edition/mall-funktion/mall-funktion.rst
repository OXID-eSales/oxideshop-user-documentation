...
`Artikel lesen <hauptshop-elternshops.html>`_ |link|
...
`Artikel lesen <subshops-supershops-multishops.html>`_ |link|
...
`Artikel lesen <vererbung/vererbung.html>`_ |link| 

.. seealso:: `Konfiguration <../../konfiguration/konfiguration.html>`_